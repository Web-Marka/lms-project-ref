    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-end" style="margin-right: 30px;">
            <ol class="breadcrumbs">
                ...
                <li><span>Blog Kategori Ekle</span></li>
            </ol>
        </div>
    </header>
            ...
            <div class="col">
                <section class="card">
                    <header class="card-header">
                        <h2 class="card-title">Blog Kategori Ekle Form</h2>
                    </header>
                    <div class="card-body">
                        <form id="myForm" action="{{ route ('store.blog.category') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            @csrf
                            ...
                            <div class="form-group row pb-4">
                                ...
                                <div class="col-lg-6 form-group">
                                    <textarea type="text" name="category_meta" class="form-control" id="category_meta"></textarea>
                                </div>
                            </div>
