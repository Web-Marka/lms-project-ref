            ...
            <div class="col">
                <section class="card">
                    <header class="card-header">
                        <h2 class="card-title">Blog Yazısı Oluştur</h2>
                    </header>
                    <div class="card-body">
                        <form id="postForm" action="{{ route ('store.blog.post') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                            @csrf
                            ...
                            <div class="form-group row pb-1">
                                ...
                                <div class="col-lg-6">
                                    <input name="blog_tags" id="blog_tags" data-role="tagsinput" data-tag-class="badge badge-primary" class="form-control" />
                                    <p>
                            ...
                            <div class="form-group row pb-4">
                                ...
                                <div class="col-lg-6 form-group">
                                    <textarea type="text" name="blog_meta" class="form-control" id="blog_meta"></textarea>
                                </div>
                            </div>
                            <div class="form-group row pb-4">
                                <label class="col-lg-3 control-label text-lg-end pt-2" for="blog_meta">Blog Kategori *</label>
                                <div class="col-lg-6">
                                    <select name="blogcat_id" class="form-control mb-3">
                            ...
                            <div class="form-group row pb-4">
                                ...
                                <div class="col-lg-6">
                                    <textarea name="blog_content" id="blog_content" data-plugin-markdown-editor rows="10"></textarea>
                                </div>
                            </div>
                            <div class="form-group row pb-4">
                            ...
                            <div class="form-group row pb-4 d-flex justify-content-center">
                                <div class="col-lg-6">
                                    <img id="postImage" src="{{ url('upload/kategori.jpg') }}"
                                        class="rounded img-fluid" height="80" width="80">
                                </div>
                            </div>
