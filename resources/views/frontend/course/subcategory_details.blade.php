                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class=" title-wrapper">
                                <h1 class="title mb--0">{{ $subcategory->subcategory_name }}</h1>
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <aside class="rbt-sidebar-widget-wrapper">
                        ...
                        <div class="rbt-single-widget rbt-widget-categories has-show-more">
                            <div class="inner">
                                <h4 class="rbt-widget-title">Alt Kategoriler</h4>
                                <ul class="rbt-sidebar-list-wrapper categories-list-check has-show-more-inner-content">

                                    @php
                                        $subcategoryId = request()->segment(3);
                                    @endphp

                                    @foreach ($subcategories as $subcat)

                                    @php
                                        $catcount = App\Models\Course::where('subcategory_id', $subcat->id)->where('status', '1')->count();
                                    @endphp

                                    <li class="rbt-check-group">
                                        <input id="cat-list-{{ $subcat->id }}" type="checkbox" name="cat-list-{{ $subcat->id }}"
                                            onclick="window.location='{{ url('subcategory/'.$subcat->subcategory_slug.'/'.$subcat->id) }}'"
                                            {{ $subcategoryId == $subcat->id ? 'checked' : '' }}>
                                        <label for="cat-list-{{ $subcat->id }}">{{ $subcat->subcategory_name }}
                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="{{ url('course/details/'.$course->course_name_slug.'/'.$course->id) }}">
                                        <img src="{{ asset($course->course_image) }}" alt="{{ asset($course->course_name) }}">
                                ...
                                <div class="rbt-card-body">
                                    <div class="rbt-card-top">
                                        ...
                                        <div class="rbt-bookmark-btn">
                                            <a class="rbt-round-btn" id="{{ $course->id }}" onclick="addToWishList(this.id)" title="İstek Listene Ekle" href="#">
                                                <i class="feather-heart"></i>
                                            </a>
                                        </div>
                                    </div>

                                    <h4 class="rbt-card-title"><a href="{{ url('course/details/'.$course->course_name_slug.'/'.$course->id) }}">{{ $course->course_name }}</a>
                                    </h4>
                                    ...
                                    <div class="rbt-card-bottom">
                                        ...
                                        <a class="rbt-btn-link" href="{{ url('course/details/'.$course->course_name_slug.'/'.$course->id) }}">
