                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class=" title-wrapper">
                                <h1 class="title mb--0">{{ $category->category_name }}</h1>
                                ...
                                <ul class="rbt-sidebar-list-wrapper instructor-list-check">
                                    ...
                                    @foreach ($instructorsWithCourseCounts as $instructor)
                                        <li class="rbt-check-group">
                                            ...
                                            onclick="window.location='{{ route('instructor.details', $instructor['instructor']->id) }}'" class="hidden-checkbox">
