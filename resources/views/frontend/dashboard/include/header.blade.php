                        ...
                        <div class="rbt-header-content justify-content-start justify-content-xl-center">
                            <div class="header-info">
                                <div class="rbt-header-top-news">
                                    <div class="inner">
                                        <div class="content">
                                            <span class="rbt-badge variation-02 bg-color-primary color-white radius-round">
                                            ...
                                            <span class="news-text"><img src="{{ asset('frontend/assets/images/icons/hand-emojji.svg') }}"
                                                    ...
                                                    Yeni Üyelere Özel %50 İndirim Fırsatı.
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="rbt-admin-profile">
                                            ...
                                            <div class="admin-info">
                                                ...
                                                <a class="rbt-btn-link color-primary"
                                                    href="{{ route('user.profile') }}">Profilim</a>
                                            </div>
                                        </div>
        ...
        <div class="rbt-search-dropdown">
            <div class="wrapper">
                ...
                <div class="row g-4 pt--30 pb--60">
                    ...
                    @php
                        $searchBarCourses = App\Models\Course::latest()
                            ->limit(4)
                            ->get();
                    @endphp
                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    <h5 class="rbt-card-title">
                                        <a
                                            href="{{ url('course/details/' . $sbc->course_name_slug . '/' . $sbc->id) }}">
                                            {{ $sbc->course_name }}
                                        </a>
                                    </h5>
