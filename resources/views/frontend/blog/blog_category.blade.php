                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active">{{ $breadcat->category_name }}</li>
                            </ul>
                            <div class="title-wrapper">
                                <h1 class="title mb--0">{{ $breadcat->category_name }}</h1>
                            </div>
                            <p class="description">{{ $breadcat->category_meta }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="inner">
                                ...
                                <ul class="rbt-sidebar-list-wrapper recent-post-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="event-details.html">
